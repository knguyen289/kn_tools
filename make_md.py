...
#python make_md.py -fnames basic_tools/basic_tools.py,ternary_tools/ternary_tools.py,rna_plot_tools/rna_plot_tools.py,rna_path_tools/rna_path_tools.py,analysis_tools/analysis_tools.py -o README.md
